...
export var Button = function (props) {
    ...
    if (btnType === "link" && href) {
        return (React.createElement("a", __assign({ className: classes, href: href }, restProps), children || btnType));
    }
    else {
        return (React.createElement("button", __assign({ className: classes, disabled: disabled }, restProps), children || btnType));
    }
};
Button.defaultProps = {
    disabled: false,
